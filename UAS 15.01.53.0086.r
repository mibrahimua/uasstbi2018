...
df<- read.csv("D:/datasentimen_uji.csv", stringsAsFactors = FALSE)
glimpse(df)

df$class <- as.factor(df$class)
custom_stopwords <- read.csv("D:/stopword.csv", header = FALSE)
...
dr<- read.csv("D:/datasentimen_test.csv", stringsAsFactors = FALSE)
factor(dr$class)
